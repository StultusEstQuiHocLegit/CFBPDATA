...
Logistic regression bankruptcy classifier trained on grouped annual filings (validation year 2023, test year 2024) with inverse-frequency class weighting and isotonic calibration. Latest model snapshot: 2025-10-30T13:33:42+01:00.

    Optimisation target: precision-recall AUC (PR AUC = 0.6899, ROC AUC = 0.6166, Brier score = 0.26).
    ...
    Primary decision point (threshold N/A) yields TP=22, FP=1, TN=641, FN=917 (precision 0.9565, recall 0.0234, F1 0.0457). Strict recall 0.8 has no available threshold with TP=736, FP=492, TN=150, FN=203 (precision 0.5993, recall 0.7838, F1 0.6793).
...
{
    "timestamp": "2025-10-30T13:33:42+01:00",
    "config": {
        "paths": {
    ...
    "operating_points": {
        "validation": {
            "primary": {
                "threshold": 1,
                "precision": 1,
                "recall": 0.03952991452991453,
                "f1": 0.07605344295991777,
                "expected_cost": 899,
                "f_beta": 0.07605344295991777,
                "support": {
                    "tp": 37,
        ...
        "test": {
            "primary": {
                ...
                "recall": 0.023429179978700747,
                "f1": 0.04573804573804574,
                "support": {
                    "tp": 22,
                    "fp": 1,
                    "tn": 641,
