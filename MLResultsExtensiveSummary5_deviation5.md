...
Logistic regression bankruptcy classifier trained on grouped annual filings (validation year 2023, test year 2024) with inverse-frequency class weighting and beta calibration. Latest model snapshot: 2025-11-07T13:45:10+01:00.

    Optimisation target: F BETA (PR AUC = 0.6882, ROC AUC = 0.6073, Brier score = 0.2425).
    Calibration thresholds (beta): probability grid unavailable -> calibrated scores unavailable.
    Primary decision point (threshold N/A) yields TP=937, FP=620, TN=22, FN=2 (precision 0.6018, recall 0.9979, F1 0.7508). Strict recall 0.8 has no available threshold with TP=745, FP=509, TN=133, FN=194 (precision 0.5941, recall 0.7934, F1 0.6794).
...
{
    "timestamp": "2025-11-07T13:45:10+01:00",
    "config": {
        "paths": {
