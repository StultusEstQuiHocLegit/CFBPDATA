...
Logistic regression bankruptcy classifier trained on grouped annual filings (validation year 2023, test year 2024) with inverse-frequency class weighting and isotonic calibration. Latest model snapshot: 2025-11-07T13:41:47+01:00.

    Optimisation target: F BETA (PR AUC = 0.6899, ROC AUC = 0.6166, Brier score = 0.26).
...
{
    "timestamp": "2025-11-07T13:41:47+01:00",
    "config": {
        "paths": {
