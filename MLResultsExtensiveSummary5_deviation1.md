...
Logistic regression bankruptcy classifier trained on grouped annual filings (validation year 2023, test year 2024) with inverse-frequency class weighting and beta calibration. Latest model snapshot: 2025-11-07T09:19:14+01:00.

    Optimisation target: F1 (PR AUC = 0.6882, ROC AUC = 0.6073, Brier score = 0.2425).
...
{
    "timestamp": "2025-11-07T09:19:14+01:00",
    "config": {
        "paths": {
