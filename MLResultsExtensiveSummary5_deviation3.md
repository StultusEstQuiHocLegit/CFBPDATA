...
Logistic regression bankruptcy classifier trained on grouped annual filings (validation year 2023, test year 2024) with inverse-frequency class weighting and beta calibration. Latest model snapshot: 2025-11-07T13:36:25+01:00.

    Optimisation target: COST (PR AUC = 0.6882, ROC AUC = 0.6073, Brier score = 0.2425).
    Calibration thresholds (beta): probability grid unavailable -> calibrated scores unavailable.
    Primary decision point (threshold N/A) yields TP=496, FP=109, TN=533, FN=443 (precision 0.8198, recall 0.5282, F1 0.6425). Strict recall 0.8 has no available threshold with TP=745, FP=509, TN=133, FN=194 (precision 0.5941, recall 0.7934, F1 0.6794).
    Calibration reliability (test deciles): [0.56-0.56]=0.56->0.63, [0.56-0.56]=0.56->0.55, [0.56-0.56]=0.56->0.6, [0.56-0.56]=0.56->0.48, [0.56-0.56]=0.56->0.28.
...
{
    "timestamp": "2025-11-07T13:36:25+01:00",
    "config": {
        "paths": {
...
{
    "pr_auc": 0.6881752543607682,
    "roc_auc": 0.6073314887249968,
    "brier": 0.242496251606459,
    "thresholds": {
        "primary": {
            "threshold": 0.5576127097226322,
            "expected_cost": 567,
            "f_beta": 0.6440677966101694
        },
        "f1_max": {
            "threshold": 0.5575015056490551,
            "expected_cost": 718,
            "f_beta": 0.7227799227799228
        },
        "recall_target": {
            "threshold": 0.5576106911147894,
            "target_recall": 0.8,
            "expected_cost": 767,
            "f_beta": 0.6613686534216335
        },
        "best": 0.5576127097226322,
        "recall80": 0.5576106911147894
    },
    "operating_points": {
        "validation": {
            "primary": {
            ...
            "recall_target": {
                "threshold": 0.5576106911147894,
                "precision": 0.563581640331076,
                "recall": 0.8002136752136753,
                "f1": 0.6613686534216335,
                "expected_cost": 767,
                "f_beta": 0.6613686534216335,
                "support": {
                    "tp": 749,
        ...
        "test": {
            ...
            "recall_target": {
                "threshold": 0.5576106911147894,
                "precision": 0.5940988835725678,
                "recall": 0.7933972310969116,
                "f1": 0.6794345645234839,
                "support": {
                    "tp": 745,
                    "fp": 509,
                    "tn": 133,
    ...
    "reliability": {
        "validation": [
            {
                "bin": 1,
                "lower": 0.5574848722983086,
                "upper": 0.5576065876441161,
                "count": 167,
                "avg_pred": 0.5575720958738616,
                "emp_rate": 0.6407185628742516
            },
            {
                "bin": 2,
                "lower": 0.5576066653227086,
                "upper": 0.5576104525582068,
                "count": 167,
                "avg_pred": 0.5576082264958055,
                "emp_rate": 0.46706586826347307
            },
            {
                "bin": 3,
                "lower": 0.5576104668397907,
                "upper": 0.557612039666806,
                "count": 167,
                "avg_pred": 0.5576115323249159,
                "emp_rate": 0.5508982035928144
            },
            {
                "bin": 4,
                "lower": 0.5576120646498146,
                "upper": 0.5576125331565924,
                "count": 167,
                "avg_pred": 0.5576123338965825,
                "emp_rate": 0.47904191616766467
            },
            {
                "bin": 5,
                "lower": 0.5576125389569344,
                "upper": 0.5576126401318423,
                "count": 167,
                "avg_pred": 0.5576126022909313,
                "emp_rate": 0.19161676646706588
            },
            {
                "bin": 6,
                "lower": 0.5576126404349748,
                "upper": 0.5576127072291825,
                "count": 167,
                "avg_pred": 0.5576126687529149,
                "emp_rate": 0.19161676646706588
            },
            {
                "bin": 7,
                "lower": 0.5576127075353827,
                "upper": 0.5576127832382067,
                "count": 167,
                "avg_pred": 0.5576127526492962,
                "emp_rate": 0.7485029940119761
            },
            {
                "bin": 8,
                "lower": 0.5576127833976765,
                "upper": 0.5576128232212737,
                "count": 167,
                "avg_pred": 0.557612798287342,
                "emp_rate": 0.8922155688622755
            },
            {
                "bin": 9,
                "lower": 0.5576128232959074,
                "upper": 0.5576130470738312,
                "count": 167,
                "avg_pred": 0.5576128973344758,
                "emp_rate": 0.7724550898203593
            },
            {
                "bin": 10,
                "lower": 0.5576130490333293,
                "upper": 0.5576136330737811,
                "count": 166,
                "avg_pred": 0.5576134012367369,
                "emp_rate": 0.6746987951807228
            }
        ],
        "test": [
            {
                "bin": 1,
                "lower": 0.5574990926913728,
                "upper": 0.5576066078249239,
                "count": 159,
                "avg_pred": 0.5575647192111548,
                "emp_rate": 0.6289308176100629
            },
            {
                "bin": 2,
                "lower": 0.5576066171264281,
                "upper": 0.5576105328019106,
                "count": 159,
                "avg_pred": 0.5576082543334852,
                "emp_rate": 0.5471698113207547
            },
            {
                "bin": 3,
                "lower": 0.557610554979444,
                "upper": 0.5576120694081654,
                "count": 159,
                "avg_pred": 0.5576114622464602,
                "emp_rate": 0.5974842767295597
            },
            {
                "bin": 4,
                "lower": 0.5576120804123396,
                "upper": 0.5576125245538279,
                "count": 159,
                "avg_pred": 0.5576123233795981,
                "emp_rate": 0.4779874213836478
            },
            {
                "bin": 5,
                "lower": 0.5576125256213944,
                "upper": 0.5576126311940637,
                "count": 159,
                "avg_pred": 0.5576125899937362,
                "emp_rate": 0.27672955974842767
            },
            {
                "bin": 6,
                "lower": 0.5576126317223175,
                "upper": 0.5576126978074255,
                "count": 159,
                "avg_pred": 0.5576126636558976,
                "emp_rate": 0.22012578616352202
            },
            {
                "bin": 7,
                "lower": 0.5576126981067997,
                "upper": 0.5576127758849905,
                "count": 159,
                "avg_pred": 0.5576127400441684,
                "emp_rate": 0.710691823899371
            },
            {
                "bin": 8,
                "lower": 0.5576127761037745,
                "upper": 0.5576128111514302,
                "count": 159,
                "avg_pred": 0.5576127915046536,
                "emp_rate": 0.9371069182389937
            },
            {
                "bin": 9,
                "lower": 0.5576128113686433,
                "upper": 0.5576130054493015,
                "count": 159,
                "avg_pred": 0.5576128725342954,
                "emp_rate": 0.8805031446540881
            },
            {
                "bin": 10,
                "lower": 0.5576130060919403,
                "upper": 0.557613633061751,
                "count": 150,
                "avg_pred": 0.557613335359934,
...
{
    "a": 0.42935278124837556,
    "b": 0.42692120673054684,
    "c": 0.825003123328597,
    "learningRate": 0.01,
    "iterations": 1000
}
