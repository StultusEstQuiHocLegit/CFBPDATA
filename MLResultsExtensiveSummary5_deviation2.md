...
Logistic regression bankruptcy classifier trained on grouped annual filings (validation year 2023, test year 2024) with inverse-frequency class weighting and isotonic calibration. Latest model snapshot: 2025-11-07T12:28:51+01:00.

    Optimisation target: COST (PR AUC = 0.6899, ROC AUC = 0.6166, Brier score = 0.26).
    ...
    Primary decision point (threshold N/A) yields TP=582, FP=163, TN=479, FN=357 (precision 0.7812, recall 0.6198, F1 0.6912). Strict recall 0.8 has no available threshold with TP=736, FP=492, TN=150, FN=203 (precision 0.5993, recall 0.7838, F1 0.6793).
...
{
    "timestamp": "2025-11-07T12:28:51+01:00",
    "config": {
        "paths": {
...

{
    ...
    "thresholds": {
        "primary": {
            "threshold": 0.3837941791765316,
            "expected_cost": 526,
            "f_beta": 0.7034949267192785
        },
        "f1_max": {
    ...
    "operating_points": {
        ...
        "test": {
            "primary": {
                "threshold": 0.3837941791765316,
                "precision": 0.7812080536912752,
                "recall": 0.6198083067092651,
                "f1": 0.6912114014251781,
                "support": {
                    "tp": 582,
                    "fp": 163,
                    "tn": 479,
